...
const NotificationCard = ({data, index, notificationState}) => {
  const {
    seen,type,reply,replied_on_comment,comment,createdAt,
    ...
    <div className={`p-6 border-b border-grey border-l-black ${ !seen && 'border-l-2'}`}>
...

      {
        ...
        <div className='ml-20 p-5 bg-grey mt-5 rounded-md'>
          ...
          <button onClick={(e)=>handleDelete(comment._id,"reply",e.target)} className='ml-14 mt-2 underline hover:text-black'>Delete</button>
